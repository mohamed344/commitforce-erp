...
/**
 * Inline SVG icons ported 1:1 from the IMAB design prototype
 * (Tableau de bord.html). Feather-style, stroke = currentColor.
 */
...
export function SalesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M3 13h13a4 4 0 0 1 4 4" />
      <path d="M17 7l4 4-4 4" />
      <path d="M21 11H8a4 4 0 0 1-4-4" />
    </svg>
  );
}
...
export function ProductionIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      <path d="M2 20h20" />
      <path d="M3 20V11l5 3V8l5 3V6l8 5v9" />
...
export function ProjectsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      ...
      <rect x="6" y="12" width="8" height="2.2" rx="1" />
      <rect x="9" y="16" width="9" height="2.2" rx="1" />
    </svg>
  );
}
...
export function HrIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M6.2 18.5a3 3 0 0 1 5.6 0" />
...
/* ── Small UI icons used by the topbar / user menu ─────────────── */
